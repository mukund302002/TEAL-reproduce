# CALIBRATION SCRIPT (C4 variant of grab_acts.py)
# C4 validation split se layer-by-layer activations collect karo aur histograms save karo.
...
#
# Usage:
#   python grab_acts_c4.py \
#       --model_name meta-llama/Llama-2-7b-hf \
#       --output_path ../../models/Llama-2-7B-c4
...
# ── C4 dataset load karo ──
# allenai/c4 English validation split use karo.
...
for sample in ds:
    ...
    if len(texts) >= 500:   # enough samples to fill 10x2048 tokens
        break

text = "\n\n".join(t for t in texts if t)
print(f"C4 total characters: {len(text)}")
